...
- Fixed OpenAI Responses and Chat Completions tool results with empty text and no image to remain empty instead of being mislabeled as an attached image ([#6103](https://github.com/earendil-works/pi/issues/6103)) by [@petrroll](https://github.com/petrroll)).
