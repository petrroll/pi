...
| `requestCompression` | For `openai-codex-responses`, SSE request-body compression policy. Default: `"auto"`; set to `"disabled"` for proxies that need plain JSON request bodies. |
